...
Is the (typically Javascript) representation of your HTML elements

2. What is an event?

An interaction with the page such as a click, scroll, etc.
...
So that we can apply array methods

5. What is a component?

A reusable segment of code composed of HTML, CSS, and JavaScript AS NEEDED.
